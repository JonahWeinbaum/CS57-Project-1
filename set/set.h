...
/**************** global types ****************/
/*
* Each node in the set linked-list
* is a keypair of the form (key, item)
*/
typedef struct keypair {
    char* key;            //Key corresponding to item
    void* item;           //Item
    struct keypair *next; //Pointer to the next keypair in the list
} keypair_t;

/*
* A set is a linked list of keypairs
* beginning at head
*/
typedef struct set {
    struct keypair *head; //Pointer to the head of the keypair list
} set_t;
